...
scData = scDatasetDropout(args.datasetName, args.discreteTag)
...
if __name__ == "__main__":
    ...
    # save for imputation
    np.save(args.npyDir+args.datasetName+'_'+args.regulized_type+discreteStr+'_featuresOriginal.npy',scData.featuresOriginal)
    np.save(args.npyDir+args.datasetName+'_'+args.regulized_type+discreteStr+'_features.npy',scData.features)
    np.save(args.npyDir+args.datasetName+'_'+args.regulized_type+discreteStr+'_dropi.npy',scData.i)
    np.save(args.npyDir+args.datasetName+'_'+args.regulized_type+discreteStr+'_dropj.npy',scData.j)
    np.save(args.npyDir+args.datasetName+'_'+args.regulized_type+discreteStr+'_dropix.npy',scData.ix)
