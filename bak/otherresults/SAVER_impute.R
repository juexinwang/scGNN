...
sc <- read.csv("/home/wangjue/biodata/scData/dcadata/chu/chu_original.csv", row.names = 1)
sav <- saver(as.matrix(sc))
sav <- sav$estimate
write.csv(sav, file = "/home/wangjue/biodata/scData/dcadata/chu/chu_saver.csv", quote = F)
