...
python3 -W ignore main.py --datasetName MMPbasal_2000 --regulized-type noregu  --npyDir ../npyImputeN2F/
python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag --regulized-type noregu  --npyDir ../npyImputeN2F/
python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --regulized-type noregu  --npyDir ../npyImputeN2F/
...
do
    ...
    python3 -W ignore main.py --datasetName MMPbasal_2000 --regulized-type noregu --reconstr $i --npyDir ../npyImputeN2F/
    python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag --regulized-type noregu --reconstr $i --npyDir ../npyImputeN2F/
    python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --regulized-type noregu --reconstr $i --npyDir ../npyImputeN2F/
done