...
python3 -W ignore main.py --datasetName MMPbasal_2000 --regulized-type noregu  --npyDir ../npyImputeN2E/
python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag  --regulized-type noregu  --npyDir ../npyImputeN2E/
python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --regulized-type noregu  --npyDir ../npyImputeN2E/
...
do
    ...
    python3 -W ignore main.py --datasetName MMPbasal_2000 --regulized-type noregu --reconstr $i --npyDir ../npyImputeN2E/
    python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag  --regulized-type noregu --reconstr $i --npyDir ../npyImputeN2E/
    python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --regulized-type noregu --reconstr $i --npyDir ../npyImputeN2E/
done