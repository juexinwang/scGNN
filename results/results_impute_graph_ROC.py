...
def getAllResults(featuresImpute,featuresOriginal):
    ...
    print('{:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} {:.4f} '.format(F1,MCC,AUC,TPR,TNR,PPV,FDR,ACC,TP,FN,FP,TN,l1ErrorMean, l1ErrorMedian, l1ErrorMin, l1ErrorMax), end='')
    print('')
...
# plt.figure()
# plt.plot(fpr_, tpr_, 'b', label='GENIE3')
# plt.xlabel('False Positive Rate') 
# plt.ylabel('True Positive Rate')
# plt.savefig('Figure1.eps', dpi=300)

# plt.figure()
# plt.plot(precision_, recall_, 'b', label='GENIE3')
# plt.xlabel('Recall')
