...
python3 -W ignore main.py --datasetName MMPbasal_2000 --npyDir ../npyImputeG1F/
python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag --npyDir ../npyImputeG1F/
python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --npyDir ../npyImputeG1F/
...
do
    ...
    python3 -W ignore main.py --datasetName MMPbasal_2000 --reconstr $i --npyDir ../npyImputeG1F/
    python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag --reconstr $i --npyDir ../npyImputeG1F/
    python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --reconstr $i --npyDir ../npyImputeG1F/
done