...
python3 -W ignore main.py --datasetName MMPbasal_2000  --npyDir ../npyImputeG2F_KMeans/
python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag  --npyDir ../npyImputeG2F_KMeans/
python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG  --npyDir ../npyImputeG2F_KMeans/
...
do
    ...
    python3 -W ignore main.py --datasetName MMPbasal_2000 --reconstr $i --npyDir ../npyImputeG2F_KMeans/
    python3 -W ignore main.py --datasetName MMPbasal_2000 --discreteTag --reconstr $i --npyDir ../npyImputeG2F_KMeans/
    python3 -W ignore main.py --datasetName MMPbasal_2000_LTMG --reconstr $i --npyDir ../npyImputeG2F_KMeans/
done