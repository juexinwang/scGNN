...
#huge matrix
methodsList = [
    ('run_experiment_1_g_e_LK_1 E1geK','--regulized-type LTMG --EMtype EM --clustering-method LouvainK --useGAEembedding --npyDir','npyG1E_LK_1a/ --seed 1'),
    ...
    ('run_experiment_2_g_f_LK_1 E2gfK','--regulized-type LTMG --EMtype celltypeEM --clustering-method LouvainK --npyDir','npyG2F_LK_1a/ --seed 1'),
    ('run_experiment_2_n_e_LK_1 E2neK','--regulized-type noregu --EMtype celltypeEM --clustering-method LouvainK --useGAEembedding --npyDir','npyN2E_LK_1a/ --seed 1'),

    ('run_experiment_1_g_e_LK_2 21geK','--regulized-type LTMG --EMtype EM --clustering-method LouvainK --useGAEembedding --npyDir','npyG1E_LK_2a/ --seed 2'),
    ...
    ('run_experiment_2_g_f_LK_2 22gfK','--regulized-type LTMG --EMtype celltypeEM --clustering-method LouvainK --npyDir','npyG2F_LK_2a/ --seed 2'),
    ('run_experiment_2_n_e_LK_2 22neK','--regulized-type noregu --EMtype celltypeEM --clustering-method LouvainK --useGAEembedding --npyDir','npyN2E_LK_2a/ --seed 2'),

    ('run_experiment_1_g_e_LK_3 31geK','--regulized-type LTMG --EMtype EM --clustering-method LouvainK --useGAEembedding --npyDir','npyG1E_LK_3a/ --seed 3'),
    ...
    ('run_experiment_2_g_f_LK_3 32gfK','--regulized-type LTMG --EMtype celltypeEM --clustering-method LouvainK --npyDir','npyG2F_LK_3a/  --seed 3'),
    ('run_experiment_2_n_e_LK_3 32neK','--regulized-type noregu --EMtype celltypeEM --clustering-method LouvainK --useGAEembedding --npyDir','npyN2E_LK_3a/  --seed 3'),
