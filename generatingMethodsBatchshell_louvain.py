...
methodsList = [
    ...
    ('run_experiment_2_g_e_LK E2geK','--regulized-type LTMG --EMtype celltypeEM --clustering-method LouvainK --useGAEembedding  --npyDir','npyG2E_LK/  --seed 2'),
    ...
    ('run_experiment_2_r_e_LK E2reK','--regulized-type LTMG01 --EMtype celltypeEM --clustering-method LouvainK --useGAEembedding  --npyDir','npyR2E_LK/  --seed 2'),
    ...
    ('run_experiment_2_g_e_LB E2geB','--regulized-type LTMG --EMtype celltypeEM --clustering-method LouvainB --useGAEembedding  --npyDir','npyG2E_LB/ --seed 2'),
    ...
    ('run_experiment_2_r_e_LB E2reB','--regulized-type LTMG01 --EMtype celltypeEM --clustering-method LouvainB --useGAEembedding  --npyDir','npyR2E_LB/ --seed 2'),
