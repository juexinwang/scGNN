...
scimpute(count_path = "/home/wangjue/biodata/scData/dcadata/chu/chu_original.csv", infile = "csv", outfile = "csv", out_dir = "/home/wangjue/biodata/scData/dcadata/chu/scimpute/", Kcluster = 2)
