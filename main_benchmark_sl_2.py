...
if __name__ == "__main__":
    ...
    if args.imputeMode:
        ...
        # np.savetxt(args.npyDir+args.datasetName+'_'+str(args.dropoutRatio)+'_'+args.regulized_type+'_reconOri.csv',reconOri,delimiter=",",fmt='%10.4f')
        np.save(args.npyDir+args.datasetName+'_'+str(args.dropoutRatio)+'_'+args.regulized_type+'_adj.npy',adjdense)
        ...
        np.save(args.npyDir+args.datasetName+'_'+args.regulized_type+'_adj.npy',adjdense)
